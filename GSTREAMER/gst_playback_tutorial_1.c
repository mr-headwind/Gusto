// To compile: gcc gst_playback_tutorial_1.c -o playback-tutorial-1 `pkg-config --cflags --libs gstreamer-1.0`
...
int main(int argc, char *argv[])
{
    ...
    /* Set the URI to play */
    //g_object_set (data.playbin2, "uri", "https://www.freedesktop.org/software/gstreamer-sdk/data/media/sintel_cropped_multilingual.webm", NULL);
    g_object_set (data.playbin2, "uri", "file:///media/tony/DATA/AstroCaptures/2022_03_19_Moon/Unprocessed/MVI_0665.MP4", NULL);
    ...
    gint64 spd = 56;
    g_object_set (data.playbin2, "connection-speed", spd, NULL);
